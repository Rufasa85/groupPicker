...
let students = ["Aaron Miller", "Adam Minkus", "Andrew Joung", "Aoki Cullan","Cameron Ousbey", "Christian O'keefe", "Christina Dias", "Daniel Rogalsky", "Devin Poore", "Edward Mara", "Everett Smith", "Georgia Chrisinger", "Helan Jose", "Heon Lee", "Iman Gure", "Jacob Zamano", "Jessica Huynh", "Joe Hutchinson", "Junhao Zhang","Keil Aloia", "Kim Chau","Lawrence Fiesta", "Maryanne Heinbaugh", "Meghan Mullally", "Monali Chandurkar", "Monica Sochenda", "Nina Teng", "Scott Willis", "Shawn Liu", "Sofia Spagnoletti", "Svitlana Yanina", "Taicheng Li", "Weimin Yang"]
let presentStudents = ["Aaron Miller", "Adam Minkus", "Andrew Joung", "Aoki Cullan","Cameron Ousbey", "Christian O'keefe", "Christina Dias", "Daniel Rogalsky", "Devin Poore", "Edward Mara", "Everett Smith", "Georgia Chrisinger", "Helan Jose", "Heon Lee", "Iman Gure", "Jacob Zamano", "Jessica Huynh", "Joe Hutchinson", "Junhao Zhang","Keil Aloia", "Kim Chau","Lawrence Fiesta", "Maryanne Heinbaugh", "Meghan Mullally", "Monali Chandurkar", "Monica Sochenda", "Nina Teng", "Scott Willis", "Shawn Liu", "Sofia Spagnoletti", "Svitlana Yanina", "Taicheng Li", "Weimin Yang"];
